...
int main() {
  ...
  smart_home::Command color_set_without_args(0, "color.set",
  ...
  smart_home::Command on_off_get_with_arg(0, "on_off.get",
  ...
  smart_home::Command brightness_set_no_args(0, "brightness.set",
                                             std::vector<smart_home::Value>{});
  ...
  require(brightness_set.getOperationId() == "brightness.set",
  ...
  require(result.has_value(), "on_off.get must return a value");
  require(std::holds_alternative<bool>(*result),
          "on_off.get must return a bool value");
